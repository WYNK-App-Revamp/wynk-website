  ...
  return (
    <>
      ...
      <section className="main-section section-inner-padding bg-wynkOffWhite flex flex-col gap-6 items-center">
        ...
        <div className="lg:w-[75%] flex items-center flex-col sm:flex-row gap-8">
      ...
      <div className="lg:px-16 flex flex-col lg:flex-row items-center gap-12 sm:gap-4">
        <div className="flex flex-col items-center lg:items-start gap-2 lg:w-1/2">
          ...
          <p className="text-[28px] sm:text-[38px] text-center lg:text-start font-bold">Secure Shopping, Worry-Free Payments</p>
          <p className="text-[18px] text-center lg:text-start text-[#212529] mb-4">Say goodbye to the uncertainties of "Payment on Delivery" issues. With our Buyer’s Protection Feature, we've redefined the way you shop online.</p>
    ...
    <section className="main-section section-inner-padding bg-wynkOffWhite">
      <div className=" lg:px-12 flex flex-col lg:flex-row gap-16">
        ...
        <div className="flex flex-col items-center lg:items-start lg:w-1/2">
          ...
          <p className="text-[28px] sm:text-[38px] text-center lg:text-start font-bold">Soar to New Horizons!</p>
    ...
    <section className="main-section section-inner-padding bg-wynkPurple-100 justify-center items-center flex flex-col gap-8">
      ...
      <p className="text-[18px] text-center lg:w-1/2 mb-2">Craving your favourite cuisine or a refreshing drink? With Wynk, ordering food and drinks is a breeze in just three simple steps</p>
      <div className="food-drinks-services flex flex-col lg:flex-row items-center justify-center gap-6">
        <ImageTexts
    ...
    <section className="main-section section-inner-padding bg-wynkOffWhite">
      <div className="px-6 lg:px-12 flex flex-col sm:flex-row items-center gap-16">
        <div className="lg:w-1/2">
          <img src="/images/wynk-social-assets.png" alt="wynk social media"/>
        </div>
        <div className="flex flex-col items-center sm:items-start gap-2 lg:w-1/2">
          <h3 className="bg-orange-500 bg-opacity-10 text-orange-500 text-sm sm:text-lg text-center font-bold p-4 rounded-full lg:w-2/5">Wynk Social</h3>
