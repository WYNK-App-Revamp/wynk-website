    ...
    <>
      <section className="main-section bg-wynkPurple-100">
        ...
        <section className="section-inner-padding flex flex-col gap-8 items-center justify-center bg-wynkPurple-100">
            <h2 className="text-[52px] font-bold"><span className="text-wynkPurple-200">Frequently</span> Asked Questions</h2>
            <p className="w-1/2 text-[18px] text-center">Here are some answers to the frequently asked questions. If you can’t find an answer, contact us.</p>
