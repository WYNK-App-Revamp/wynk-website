...
function ShareOwnershipScheme() {
  ...
  return (
      ...
      <section className="scheme-hero-section section-inner-padding flex flex-col-reverse md:flex-row items-center gap-4">
        <div className="md:w-3/4 flex flex-col md:items-start">
          ...
          <div className="call-to-actions flex justify-center md:items-start gap-3">
            ...
            className="border-wynkPurple-200 border rounded-md h-12 py-3 px-6 flex items-center text-center text-base sm:text-xl text-wynkPurple-200">Login</button>
            <div>
    ...
    <section className="main-section section-inner-padding bg-wynkOffWhite flex flex-col gap-12 items-center">
      <div>
      ...
      <section className="why-join-the-scheme">
        ...
        <div className="flex flex-col gap-5 ">
          ...
          <img className="rounded-xl sm:w-3/4" src="/images/handshake.png" alt="handshake"/>
        </div>
      </section>
      <section className="why-join-the-scheme">
        <div className="scheme-points">
        ...
        <div className="flex flex-col gap-5 ">
          ...
          <img className="rounded-xl sm:w-3/4" src="/images/handsome-elegant-man.png" alt="handshake"/>
        </div>
      </section>
      <section className="why-join-the-scheme">
        <div className="scheme-points">
        ...
        <div className="flex flex-col gap-5">
          ...
          <img className="rounded-xl sm:w-3/4" src="/images/happy-business-man.png" alt="handshake"/>
        </div>
      </section>
      <section className="why-join-the-scheme">
        <div className="scheme-points">
        ...
        <div className="flex flex-col gap-5 ">
          ...
          <img className="rounded-xl sm:w-3/4" src="/images/closeup-delivery-person.png" alt="handshake"/>
        </div>
      </section>
    </section>
