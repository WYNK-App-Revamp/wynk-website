  ...
  return (
    ...
    <section className="main-section bg-wynkPurple-100">
      ...
      <section className="section-inner-padding flex flex-col justify-center items-center gap-2 sm:gap-8">
        ...
        <p className="text-[18px] px-2 sm:px-8 sm:w-3/5 text-center mb-[500px] sm:mb-2">We'd like to hear from you. Send us a message and we'll be pleased to answer any questions you have or treat any problems you're experiencing.</p>
      </section>
    </section>
