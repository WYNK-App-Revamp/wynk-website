  ...
  return (
    ...
    <section className="download-wynk-card">
      <div className="w-3/5 items-start">
        ...
        <p className=" text-sm sm:text-xl mb-5 w-full pr-8 font-medium">To download the Wynk super app, use the camera on your phone to scan the QR code. Accessible on iOS and Android platforms.</p>
